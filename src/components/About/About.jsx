          ...
          <Col md={6} sm={12}>
            <Fade left={isDesktop} bottom={isMobile} duration={1000} delay={1000} distance="30px">
              <div className="about-wrapper__info">
                ...
                <p className="about-wrapper__info-text">
                  I love to build things that people use. My proudest achievement is my product comparison platform (<a target="_blank" href="https://patrickcollings.github.io/my-aquarium-builder/">myaquariumbuilder</a>) that I designed, built and marketed over lockdown.                 
                </p>
                {resume && (
